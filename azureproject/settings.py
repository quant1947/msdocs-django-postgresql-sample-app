...
conn_str = "dbname=pythonapp host=saplpune-7szhzfylpzavm-postgres-server.postgres.database.azure.com port=5432 sslmode=require user=postgresadmin password=Z5afV9y0LX7wbO5"
